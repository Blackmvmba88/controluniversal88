...
function testChooseCandidateSingleBit() {
  const diffs = [{ idx:5, before:0, after:16, xor:16 }, { idx:6, before:0, after:3, xor:3 }];
...
module.exports = { testPrintDiff, testChooseCandidateSingleBit, testInferButtonMappings, testInferDpadByte };
